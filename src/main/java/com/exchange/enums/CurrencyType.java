...
public enum CurrencyType {
    ...
    public static CurrencyType getByValue(String text) throws UnsupportedCurrencyTypeException {
        return Arrays.stream(CurrencyType.values()).filter(v -> v.value.equals(text)).findFirst().orElseThrow(() -> new UnsupportedCurrencyTypeException(String.format("Unsupported currency type %s.", text)));
    }
